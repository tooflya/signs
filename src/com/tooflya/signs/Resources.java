...
public class Resources {
	...
	static
	{
		...
		default:
			...
			mDifficultyEasyButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.difficulty_menu_btn_easy), 776, 759, 1, 1);
			...
			//mAchivTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_achiv_text_popup), 748, 832, 1, 1);
			...
			mGameRollButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_btn_roll), 847, 913, 1, 1);
			...
			mPopupNoButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_menu_popup_btn_no), 931, 832, 1, 1);
			mPopupYesButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_menu_popup_btn_yes), 952, 643, 1, 1);
			mPopupBackMenuTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_menu_popup_text), 603, 478, 1, 1);
			...
			mTapToPlayButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_btn_taptoplay), 608, 424, 1, 1);
			...
			mBestScoreTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_best), 878, 416, 1, 1);
			mEasyTextModeTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_mode_easy), 235, 943, 1, 1);
			mExpertTextModeTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_mode_expert), 776, 800, 1, 1);
			mNormalTextModeTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_mode_normal), 776, 691, 1, 1);
			mTextSCoreTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_score), 634, 727, 1, 1);
			mTextStarsTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_stars), 847, 886, 1, 1);
			...
			mGetStarsTxtTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_get_stars_text), 2, 943, 1, 1);
			...
			mHarryUpTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_timer_popup_minute), 768, 879, 1, 1);

			mBestScoreBackgroundTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_best_score_popup), 481, 958, 1, 1);
			...
			mMoreButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_btn_more), 861, 373, 1, 1);
			...
			mGLetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_g), 960, 2, 1, 1);
			...
			mILetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_i), 438, 960, 1, 1);
			...
			mNLetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_n), 948, 145, 1, 1);
			...
			mS1LetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_s_first), 960, 70, 1, 1);
			...
			mS2LetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_s), 948, 249, 1, 1);
			mExitTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_quit_popup_text), 742, 115, 1, 1);
			...
			mBuyButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_btn_buy), 2, 981, 1, 1);
			...
			mGetStarsTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_btn_get_stars), 796, 675, 1, 1);
			mPurchasedTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_btn_purchased), 608, 954, 1, 1);
			...
			mStarsBackgroundTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_stars_bg), 2, 850, 1, 1);
			...
			mFunnyFacesTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_1), 40, 981, 1, 1);
			mHeadStafTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_2), 203, 978, 1, 1);
			mMustacheTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_3), 298, 972, 1, 1);
			mGlassesTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_4), 948, 223, 1, 1);
			...
			m2 = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas4, Game.mContext, Game.mContext.getString(R.string.popup_achiv_lock), 402, 452, 1, 1);
			break;
		case Resolutions.HD:
			...
			mDifficultyEasyButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.difficulty_menu_btn_easy), 1428, 1433, 1, 1);
			mDifficultyExpertButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.difficulty_menu_btn_expert), 1428, 1362, 1, 1);
			mDifficultyNormalButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.difficulty_menu_btn_normal), 1111, 1397, 1, 1);
			...
			//mAchivTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_achiv_text_popup), 1851, 740, 1, 1);
			...
			mGameRollButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_btn_roll), 710, 1208, 1, 1);
			...
			mShowTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, "game-gui/game-gui-light-sprite.png", 2, 2, 10, 1);
			mPopupNoButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_menu_popup_btn_no), 710, 1393, 1, 1);
			mPopupYesButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_menu_popup_btn_yes), 1286, 1693, 1, 1);
			mPopupBackMenuTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_menu_popup_text), 1678, 2, 1, 1);
			...
			mTapToPlayButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_btn_taptoplay), 1143, 252, 1, 1);
			...
			mBestScoreTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_best), 1656, 229, 1, 1);
			mEasyTextModeTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_mode_easy), 507, 1102, 1, 1);
			mExpertTextModeTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_mode_expert), 836, 930, 1, 1);
			mNormalTextModeTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_mode_normal), 836, 2001, 1, 1);
			mTextSCoreTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_score), 1309, 2000, 1, 1);
			mTextStarsTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_end_lvl_text_stars), 1160, 2000, 1, 1);
			...
			mGetStarsTxtTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_get_stars_text), 1586, 291, 1, 1);
			...
			mBuyButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_btn_buy), 1851, 559, 1, 1);
			...
			mGetStarsTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_btn_get_stars), 1851, 1028, 1, 1);
			mPurchasedTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_btn_purchased), 1129, 1907, 1, 1);
			...
			mStarsBackgroundTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_stars_bg), 710, 1473, 1, 1);
			...
			mFunnyFacesTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_1), 1146, 1652, 1, 1);
			mHeadStafTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_2), 1851, 822, 1, 1);
			mMustacheTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_3), 1730, 1993, 1, 1);
			mGlassesTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.popup_shop_stuff_text_4), 1922, 229, 1, 1);
			...
			mHarryUpTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas1, Game.mContext, Game.mContext.getString(R.string.game_gui_timer_popup_hurryup), 988, 1907, 1, 1);

			mBestScoreBackgroundTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_best_score_popup), 1723, 237, 1, 1);
			...
			mMoreButtonTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_btn_more), 1912, 914, 1, 1);
			...
			mGLetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_g), 1354, 856, 1, 1);
			...
			mILetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_i), 1959, 318, 1, 1);
			...
			mNLetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_n), 1354, 718, 1, 1);
			...
			mS1LetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_s_first), 1351, 970, 1, 1);
			...
			mS2LetterTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_name_s), 1921, 425, 1, 1);
			mExitTextTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas2, Game.mContext, Game.mContext.getString(R.string.main_menu_quit_popup_text), 1388, 2, 1, 1);
			...
			m2 = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mElementsTextureAtlas4, Game.mContext, Game.mContext.getString(R.string.popup_achiv_lock), 802, 452, 1, 1);
			break;
		}
	}
