...
import com.tooflya.billing.BillingSecurity.VerifiedPurchase;
import com.tooflya.billing.C.ResponseCode;
...
public class BillingHelper {
	...
	public static Handler mCompletedHandler;
	
	public static VerifiedPurchase latestPurchase;
	
	public static void instantiateHelper(Context context, IMarketBillingService service) {
		mService = service;
		mContext = context;
	}
